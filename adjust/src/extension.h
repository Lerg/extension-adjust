...
#define EXTENSION_SET_ENABLED FUNCTION_NAME_EXPANDED(EXTENSION_NAME, set_enabled)
...
#define EXTENSION_SET_OFFLINE_MODE FUNCTION_NAME_EXPANDED(EXTENSION_NAME, set_offline_mode)
int EXTENSION_SET_OFFLINE_MODE(lua_State *L);

#define EXTENSION_SEND_FIRST_PACKAGES FUNCTION_NAME_EXPANDED(EXTENSION_NAME, send_first_packages)
int EXTENSION_SEND_FIRST_PACKAGES(lua_State *L);

#define EXTENSION_APP_WILL_OPEN_URL FUNCTION_NAME_EXPANDED(EXTENSION_NAME, app_will_open_url)
...
#define EXTENSION_GET_IDFA FUNCTION_NAME_EXPANDED(EXTENSION_NAME, get_idfa)
